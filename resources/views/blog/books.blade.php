...
@section('content')
    ...
    <div class="hero-area">
        ...
        <div class="hero-slides owl-carousel">
           <!-- Single Slide -->
           <div class="single-hero-slide bg-img background-overlay"  style="background-image: url({{asset('/img/blog-img/kak.jpg')}});"></div>
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img background-overlay"  style="background-image: url({{asset('/img/blog-img/lolo.jpg')}});"></div>
            <!-- Single Slide -->
            <div class="single-hero-slide bg-img background-overlay"  style="background-image: url({{asset('/img/blog-img/RDCu07R.jpg')}});"></div>
                        ...
                        <div class="world-catagory-area mt-50">
                            ...
                            <div class="tab-content" id="myTabContent2">
                                ...
                                <div class="tab-pane fade show active" id="world-tab-10" role="tabpanel" aria-labelledby="tab10">
                                    ...
                                    @foreach ($post1 as $posts1)
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="single-blog-post wow fadeInUpBig">
                                                ...
                                                <img src="{{asset(Voyager::image($posts1->thumbnail('medium')))}}" alt="post1">
                                                    <!-- Catagory -->
                                                    ...
                                                    <a href="/detail-blog/{{$posts2->category_id}}/{{$posts2->slug}}">
                                                        ...
                                                        <div class="col-12 col-md-6">
                                                            ...
                                                            <div class="single-blog-post post-style-2 d-flex align-items-center mb-1">
                                                                <!-- Post Thumbnail -->
                                                                <div class="post-thumbnail">
                                                                <img src="{{asset(Voyager::image($posts2->thumbnail('small')))}}" alt="post2">
                                                                </div>
                                                                <!-- Post Content -->
                                                                <div class="post-content">
                                                                    <a href="#" class="headline">
                                    ...
                                    <!-- Post Thumbnail -->
                                        <div class="post-thumbnail">
                                      <img src="{{asset(Voyager::image($posts3->thumbnail('small')))}}" alt="post3">
                                             </div>
                                       <!-- Post Content -->
                                   <div class="post-content">
                           <a href="#" class="headline">
...
@foreach ($post as $posts)
                        <a href="/detail-blog/{{$posts->category_id}}/{{$posts->slug}}">
